...
var waves = [
	...
	DialogueWave.create(self, 3, "Captain, we've lost power to the boosters."),
	DialogueWave.create(self, 5, "Damage doesn't look too bad. We should be able to get them up again soon."),
	DialogueWave.create(self, 3, "Just need a little time."),
	TimerWave.create(2),
	DialogueWave.create(self, 3, "Uh oh, enemies inbound. Without the boosters, we're stuck here."),
	DialogueWave.create(self, 3, "No choice but to use our shields. Hope they hold."),
	...
	MultiWave.create([
		DialogueWave.create(self, 5, "Hold space to absorb their shots and shoot them back!"),
	...
	TimerWave.create(0.3),
	DialogueWave.create(self, 1, "longer!"),
	TimerWave.create(1),
	MultiWave.create([
		...
		SequenceWave.create([
			TimerWave.create(12),
			DialogueWave.create(self, 3, "We can't hold much longer!"),
		]),
	]),
	...
	DialogueWave.create(self, 100, "You win! You can quit the game now :)")
]
